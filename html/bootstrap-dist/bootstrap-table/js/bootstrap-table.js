...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div><div class="pull-right pagination pagination-index"><input type="text"><a href="javastcript:;" class="page-link">跳转</a></div>',
                sprintf('<div class="%s-%s pagination">', bs.pullClass, this.options.paginationHAlign),
                '<ul class="pagination' + sprintf(' pagination-%s', this.options.iconSize) + '">',
                sprintf('<li class="page-first"><a href="javastcript:;" class="page-link">首页</a></li><li class="page-item page-pre"><a class="page-link" href="#">上一页</a></li>',
            ...
            html.push(
                sprintf('<li class="page-item page-next"><a class="page-link" href="#">下一页</a></li><li class="page-last"><a href="javastcript:;" class="page-link">末页</a></li>',
